...
export interface ConversationMessageEditFormProps {
...
export const ConversationMessageEditForm: React.FC<
    ConversationMessageEditFormProps
> = ({ message, conversationId, conversationStatus, onCancel, onSaved }) => {
    ...
    const describedBy = [session.errorMessage ? errorId : null, counterId]
    ...
    return (
        ...
        >
            <Label htmlFor={textareaId} className="text-xs">
                {t('side_panel.conversations_section.detail.edit.label')}
            </Label>
            <Textarea
                ref={textareaRef}
                id={textareaId}
            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
                ...
                >
                    {t('side_panel.conversations_section.detail.edit.cancel')}
                </Button>
                <Button
                    type="submit"
                    size="sm"
