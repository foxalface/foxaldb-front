...
describe('ChannelManager selection transport', () => {
    afterEach(() => {
        clearEchoInstance();
    });

    it('sends selection payloads through the diagram presence channel', () => {
