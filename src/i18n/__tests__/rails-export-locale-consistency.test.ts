...
describe('Rails export locale consistency', () => {
    const englishNoteLeaves = collectLeafPaths(
        en.translation.export_wizard.rails.result_step.notes
    );

    it('contains every required Rails key in all supported locales', () => {
    ...
    it('contains the same Rails note key structure as English in every locale', () => {
        for (const locale of locales) {
            const noteLeaves = collectLeafPaths(
                locale.translation.export_wizard.rails.result_step.notes
            );
    ...
    it('does not leave English sentence placeholders in non-English locales', () => {
        const englishSentences = [
            ...
            en.translation.export_wizard.rails.result_step.download_zip,
            en.translation.export_wizard.rails.result_step.retry,
            en.translation.export_wizard.rails.result_step.error_semantic,
            en.translation.export_wizard.rails.result_step
                .error_unauthenticated,
            en.translation.export_wizard.rails.result_step
                .error_invalid_request,
            en.translation.export_wizard.rails.result_step.error_rate_limited,
            en.translation.export_wizard.rails.result_step.error_unexpected,
            en.translation.export_wizard.rails.result_step.error_unsafe_path,
            en.translation.export_wizard.rails.result_step.error_empty_files,
            en.translation.export_wizard.rails.result_step
