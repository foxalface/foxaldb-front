...
import { drizzleExportNoteMessages } from '../drizzle-export-notes/uk';
...
export const uk: LanguageTranslation = {
    translation: {
        ...
        delete_diagram_alert: {
            ...
            description:
                'Цю дію не можна скасувати. Діаграму буде видалено назавжди.',
            cancel: 'Скасувати',
            delete: 'Видалити',
        },
        ...
        diagram_access: {
            removed: {
                title: 'Доступ видалено',
                description: 'У вас більше немає доступу до цієї діаграми.',
            },
            role_changed_viewer: {
        ...
        new_diagram_dialog: {
            ...
            import_schema: {
                ...
                ambiguous: {
                    ...
                    multiple_dbms_title: 'Виявлено кілька СУБД',
                    selection_help_percentages:
                        'Відсотки показують індекс відповідності SQL-діалекту для кожної СУБД.',
                    selection_help_recommended:
                        'Зірка позначає рекомендовану СУБД.',
                    selection_help_aria: 'Довідка про відсотки та рекомендацію',
                    confidence_explanation:
                        'Відсотки вказують на індекс відповідності виявленому діалекту SQL для кожної СУБД.',
                    description:
                    ...
                    recommended_tooltip: 'Рекомендована СУБД',
                    recommended_aria: '{{database}}, рекомендована СУБД',
                    candidate: '{{database}}',
                },
                diagram_json: {
                    detection: {
                    ...
                    ambiguous: {
                        ...
                        selection_help_percentages:
                            'Відсотки показують індекс відповідності для кожної СУБД.',
                        selection_help_recommended:
                            'Зірка позначає СУБД, зазначену у файлі.',
                        selection_help_aria:
                            'Довідка про відсотки та рекомендацію',
                ...
                project: {
                    ...
                    analyzing_project: 'Аналіз архіву проєкту…',
                    detected: 'Виявлено проєкт {{framework}}',
                    migrations_found_one: 'Знайдено {{count}} міграцію',
                    migrations_found_other: 'Знайдено {{count}} міграцій',
                    schema_files_found_one: 'Знайдено {{count}} файл схеми',
                    schema_files_found_other: 'Знайдено {{count}} файлів схеми',
                    model_snapshots_found_one:
                        'Знайдено {{count}} знімок моделі',
                    model_snapshots_found_other:
                        'Знайдено {{count}} знімків моделі',
                    sql_migrations_found_one: 'Знайдено {{count}} SQL-міграцію',
                    sql_migrations_found_other:
                        'Знайдено {{count}} SQL-міграцій',
                    migrations_button_one: 'Знайдено {{count}} міграцію',
                    migrations_button_other: 'Знайдено {{count}} міграцій',
                    schema_files_button_one: 'Знайдено {{count}} файл схеми',
                    schema_files_button_other:
                        'Знайдено {{count}} файлів схеми',
                    model_snapshots_button_one:
                        'Знайдено {{count}} знімок моделі',
                    model_snapshots_button_other:
                        'Знайдено {{count}} знімків моделі',
                    sql_migrations_button_one:
                        'Знайдено {{count}} SQL-міграцію',
                    sql_migrations_button_other:
                        'Знайдено {{count}} SQL-міграцій',
                    multiple_projects_title: 'Виявлено кілька схем баз даних',
                    multiple_projects_description:
                        'Цей архів містить більше одного підтримуваного проєкту бази даних. Виберіть, який імпортувати.',
                    multiple_database_groups_title:
                        'Виявлено кілька схем бази даних',
                    multiple_database_groups_description:
                        'Цей проєкт містить кілька схем бази даних. Виберіть, яку імпортувати.',
                    choose_database_group: 'Виберіть схему бази даних',
                    group_recommended_aria: 'Рекомендовано {{label}}',
                    group_recommended_tooltip: 'Рекомендована схема',
                    choose_project: 'Виберіть проєкт',
                    unsupported_project: 'Непідтримуваний архів проєкту',
                    unsupported_project_description:
                        'У цьому архіві не знайдено підтримуваний проєкт Laravel, Prisma, Drizzle, Rails, Entity Framework Core або Django.',
                    project_root: 'Корінь проєкту: {{path}}',
                    sign_in_to_import_framework:
                        'Увійдіть, щоб імпортувати проєкти {{framework}}, коли імпорт стане доступним.',
                    remote_processing_notice:
                        'Коли імпорт стане доступним, оброблятимуться лише файли, пов’язані зі схемою.',
                    remote_processing_scope:
                        'Повний архів і непов’язаний вихідний код ніколи не завантажуються.',
                    remote_processing_security:
                        'Аналіз статичний і не виконує завантажений код.',
                },
                errors: {
                    ...
                    archive_too_large:
                        'Вибраний архів проєкту більший за 50 МБ.',
                    archive_invalid:
                        'Вибраний файл не є дійсним архівом проєкту.',
                    unsupported_file_extension:
                        'Підтримуються лише файли .sql, .dbml, .json та архіви проєктів .zip.',
                    import_failed:
                        'Не вдалося імпортувати схему. Перевірте вміст і спробуйте знову.',
                    invalid_diagram_json:
                        'JSON діаграми недійсний. Перевірте файл і повторіть спробу.',
                },
            },
        ...
        export_wizard: {
            ...
            targets: {
                ...
                drizzle: {
                    title: 'Drizzle',
                    description: 'Експорт пакета схеми Drizzle 0.45',
                },
                png: {
                    title: 'PNG',
            ...
            json: {
                download_step: {
                    description: 'Експортуйте портативну копію цієї діаграми.',
                    explanation:
            ...
            drizzle: {
                ...
                result_step: {
                    ...
                    generating: 'Генерація пакета Drizzle…',
                    success: 'Пакет Drizzle згенеровано.',
                    generated_files: 'Згенеровані файли ({{count}})',
                    notes_heading: 'Примітки',
                    warnings_heading: 'Попередження ({{count}})',
                    adaptations_heading: 'Технічні адаптації ({{count}})',
                    ...
                    download_zip: 'Завантажити ZIP',
                    retry: 'Повторити',
                    error_semantic: 'Не вдалося згенерувати пакет Drizzle.',
                    error_unauthenticated:
                        'Щоб експортувати пакети Drizzle, потрібно увійти.',
                    error_invalid_request:
                        'Не вдалося експортувати діаграму. Вона може бути недійсною або надто великою.',
                    error_rate_limited:
                        'Надто багато запитів на експорт. Зачекайте трохи й спробуйте знову.',
                    error_unexpected:
                        'Експорт Drizzle не вдався на сервері. Спробуйте ще раз.',
                    error_network:
                        'Не вдалося зв’язатися із сервером. Перевірте з’єднання й спробуйте знову.',
                    error_unsafe_path:
                        'Експорт містить небезпечний шлях до файлу і не був завантажений.',
                    error_empty_files: 'Експорт не містив жодного файлу.',
                    error_invalid_package:
                        'Згенерований пакет недійсний і не був завантажений.',
                    errors: {
                        unsupported_database:
                            'Експорт Drizzle недоступний для цього типу бази даних.',
                        empty_diagram:
                            'На діаграмі немає таблиць для експорту.',
                        unsupported_structural_field:
                            'Поле первинного ключа або структурне поле на «{{path}}» не можна зобразити в Drizzle.',
                        mysql_catalog_collision:
                            'Кілька каталогів MySQL містять ту саму фізичну таблицю «{{path}}» і їх не можна безпечно звести в одну схему Drizzle MySQL.',
                        mariadb_catalog_collision:
                            'Кілька каталогів MariaDB містять ту саму фізичну таблицю «{{path}}» і їх не можна безпечно звести в одну схему Drizzle MariaDB.',
                    },
                },
            },
            laravel: {
                options_step: {
                    ...
                    explanation:
                        'Створіть ZIP-архів файлів міграцій Laravel із поточної діаграми.',
                    filename_label: 'Ім’я файлу: {{filename}}',
                    ...
                    export: 'Експортувати',
                    generating: 'Створення міграцій Laravel...',
                    error: 'Не вдалося експортувати міграції Laravel. Спробуйте ще раз.',
                    error_unauthenticated:
                        'Щоб експортувати міграції Laravel, потрібно увійти.',
                    error_forbidden:
                        'У вас немає дозволу експортувати цю діаграму.',
                    error_not_found: 'Цю діаграму не знайдено.',
                    error_empty: 'У цій діаграмі немає таблиць для експорту.',
                    error_invalid:
                        'Не вдалося експортувати діаграму. Перевірте схему й спробуйте знову.',
                    error_network:
                        'Не вдалося з’єднатися із сервером. Перевірте мережу й спробуйте знову.',
                },
            },
        },
