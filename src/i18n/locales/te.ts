    ...
    translation: {
        ...
        side_panel: {
            ...
            conversations_section: {
                ...
                detail: {
                    ...
                    composer: {
                        ...
                        form_aria_label: 'కొత్త సంభాషణ సందేశం',
                        keyboard_hint:
                            'పంపడానికి Enter నొక్కండి. కొత్త పంక్తికి Shift+Enter.',
                        counter_aria_label:
                            '{{count}} / {{max}} అక్షరాలు ఉపయోగించబడ్డాయి',
                        errors: {
                            empty: 'పంపడానికి సందేశం నమోదు చేయండి.',
                            too_long: 'సందేశాలు 2000 అక్షరాలకు మించకూడదు.',
                            create_failed:
                                'సందేశం పంపలేకపోయాం. దయచేసి మళ్లీ ప్రయత్నించండి.',
                        },
                    },
                    edit: {
                        label: 'సందేశం',
                        form_aria_label: 'సంభాషణ సందేశాన్ని సవరించు',
                        save: 'సేవ్ చేయి',
                        ...
                        counter_aria_label:
                            '{{count}} / {{max}} అక్షరాలు ఉపయోగించబడ్డాయి',
                        errors: {
                            empty: 'సేవ్ చేయడానికి సందేశం నమోదు చేయండి.',
                            too_long: 'సందేశాలు 2000 అక్షరాలకు మించకూడదు.',
                            update_failed:
                                'సందేశం నవీకరించలేకపోయాం. దయచేసి మళ్లీ ప్రయత్నించండి.',
                        },
                    },
                    delete_dialog: {
                        title: 'సందేశం తొలగించు',
                        description:
                            'మీరు ఈ సందేశాన్ని తొలగించాలని ఖచ్చితంగా అనుకుంటున్నారా? ఈ చర్యను రద్దు చేయలేరు.',
                        cancel: 'రద్దు',
                        confirm: 'తొలగించు',
                        deleting: 'తొలగిస్తోంది…',
                        errors: {
                            delete_failed:
                                'ఈ సందేశం తొలగించలేకపోయాం. దయచేసి మళ్లీ ప్రయత్నించండి.',
                        },
                    },
                    mutation_errors: {
                        forbidden: 'ఈ సందేశాన్ని మార్చడానికి మీకు అనుమతి లేదు.',
                        archived:
                            'ఈ సంభాషణ ఆర్కైవ్ చేయబడింది మరియు చదవడానికి మాత్రమే.',
                        not_found: 'ఈ సంభాషణ లేదా సందేశం ఇక అందుబాటులో లేదు.',
                    },
                },
            ...
            activities_section: {
                title: 'కార్యకలాపం',
                filter: 'ఫిల్టర్',
                clear: 'ఫిల్టర్ తొలగించు',
                no_results: 'మీ ఫిల్టర్‌కు సరిపోయే కార్యకలాపం కనుగొనబడలేదు.',
                loading: 'కార్యకలాపం లోడ్ అవుతోంది…',
                retry: 'మళ్లీ ప్రయత్నించు',
                type_filter: {
                    trigger: 'రకం',
                    label: 'రకం ద్వారా ఫిల్టర్ చేయి',
                    trigger_aria: 'కార్యకలాప రకం ద్వారా ఫిల్టర్ చేయి',
                },
                types: {
                    diagram: 'రేఖాచిత్రం',
                    table: 'పట్టిక',
                ...
                unknown_user: 'ఎవరో',
                empty_state: {
                    title: 'ఇంకా కార్యకలాపం లేదు',
                    description:
                        'ఇటీవలి మార్పులను చూడటానికి సవరణ ప్రారంభించండి.',
                },
                errors: {
                    load_failed: 'కార్యకలాపాన్ని లోడ్ చేయలేకపోయాం.',
                },
                actions: {
                    add_tables: '{{user}} పట్టిక {{table}} ను జోడించారు',
                    remove_tables: '{{user}} ఒక పట్టికను తీసివేశారు',
                    add_field: '{{user}} ఫీల్డ్ {{field}} ను జోడించారు',
                    remove_field: '{{user}} ఒక ఫీల్డ్‌ను తీసివేశారు',
                    update_field: '{{user}} ఫీల్డ్ {{field}} ను నవీకరించారు',
                    add_relationships: '{{user}} సంబంధాన్ని జోడించారు',
                    remove_relationships: '{{user}} సంబంధాన్ని తీసివేశారు',
                    update_relationship: '{{user}} సంబంధాన్ని నవీకరించారు',
                    add_notes: '{{user}} నోట్‌ను జోడించారు',
                    remove_notes: '{{user}} నోట్‌ను తీసివేశారు',
                    add_areas: '{{user}} ప్రాంతాన్ని జోడించారు',
                    remove_areas: '{{user}} ప్రాంతాన్ని తీసివేశారు',
                    add_dependencies: '{{user}} ఆధారాన్ని జోడించారు',
                    remove_dependencies: '{{user}} ఆధారాన్ని తీసివేశారు',
            ...
            laravel: {
                options_step: {
                    ...
                    include_indexes_description:
                        'స్పష్టమైన టేబుల్ ఇండెక్స్ నిర్వచనాలను ఎగుమతి చేయండి.\nఫీల్డ్-స్థాయి యూనిక్ నిబంధనలు ఎల్లప్పుడూ చేరి ఉంటాయి.',
        ...
        guest_migration_dialog: {
            title: 'స్థానిక డయాగ్రామ్ దిగుమతి చేయాలా?',
            description:
                'ఈ పరికరంలో డయాగ్రామ్ సేవ్ చేయబడింది. ఎక్కడినుంచైనా యాక్సెస్ చేయడానికి మీ ఖాతాలో దిగుమతి చేయండి.',
            import: 'ఖాతాలో దిగుమతి చేయండి',
            continue_without_import: 'దిగుమతి చేయకుండా కొనసాగించండి',
        },

        guest_migration_errors: {
            import_failed:
                'స్థానిక డయాగ్రామ్ దిగుమతి చేయలేకపోయింది. స్థానిక కాపీ సంరక్షించబడింది.',
            activation_failed:
                'డయాగ్రామ్ సృష్టించబడింది కానీ తెరవలేకపోయింది. స్థానిక కాపీ సంరక్షించబడింది.',
            cleanup_failed:
