...
export const ja: LanguageTranslation = {
    translation: {
        ...
        auth: {
            ...
            settings: {
                title: 'ユーザー設定',
                description: '個人情報とパスワードを更新します。',
                change_password_heading: 'パスワードを変更',
                current_password_label: '現在のパスワード',
                new_password_label: '新しいパスワード',
                password_confirmation_label: '新しいパスワードを確認',
                first_name_label: '名',
                last_name_label: '姓',
                email_label: 'メールアドレス',
                submit: '変更を保存',
                ...
                success_description: 'プロフィールを保存しました。',
            },
            nav: {
                sign_in: 'サインイン',
                logout: 'ログアウト',
