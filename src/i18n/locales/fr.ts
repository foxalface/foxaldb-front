    ...
    translation: {
        ...
        export_wizard: {
            ...
            generated_files: {
                ...
                close_preview_aria: "Fermer l'aperçu du fichier",
            },
            sql: {
                target_step: {
                    title: 'Exporter SQL',
            ...
            targets: {
                unsupported_framework:
                    'Export {{framework}} incompatible avec le SGBD du diagramme',
                sql: {
                    title: 'SQL',
                    description:
            ...
            laravel: {
                options_step: {
                    ...
                    include_indexes_description:
                        'Exporter les définitions d’index explicites.\nLes contraintes d’unicité au niveau des champs sont toujours incluses.',
